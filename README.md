# swe_skill_matching (Product Catalog Dataset)
...
- `swe_skill_matching.csproj` - Launcher that lets you choose which console app to run.
...
dotnet run --project swe_skill_matching.csproj
